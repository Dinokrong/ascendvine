...
const VALUATION = [
  ...
  {
    "id": 652,
    "question": "Two companies have the same financial statements, growth projections, same industry, but trade at different EV/EBITDA multiples.\nWhy could that happen?",
    "answer": "Qualitative factors the numbers miss: Perceived risk (contract quality, customer concentration) Management credibility or governance Liquidity of the float or index inclusion M&A rumors or takeover premium Differing ESG profiles or regulatory risks",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Sources and proxies: Add D&A from the cash‑flow statement to EBIT from the income statement. Use management presentations or lender information memos. Check equity research or industry reports. Ask management directly or infer using peer margins.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Beta measures how much an asset’s returns move relative to the market; it captures systematic risk. Because Bitcoin is highly volatile and tends to swing more than the equity market, it would have a Beta well above 1.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "They raise the risk‑free rate in CAPM and typically widen equity risk premia, so the cost of equity increases.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Current market factors affecting valuation: Interest Rates: Higher rates compress multiples by increasing discount rates and reducing PV of future cash flows. Inflation: Erodes purchasing power and margins; investors demand higher returns. Economic Growth: Slower growth reduces revenue expectations and multiples. Market Sentiment: Risk-on vs. risk-off environments affect investor appetite for growth vs. value stocks. Sector Trends: AI, energy transition, healthcare innovation drive premium multiples in certain sectors. Geopolitical Risk: Trade tensions, conflicts create uncertainty, compressing valuations. Credit Markets: Tighter credit conditions increase cost of capital and reduce leverage availability. M&A Activity: Robust deal flow can drive multiples higher; quiet markets compress them.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "CAGR (compound annual growth rate) is the annualized rate assuming compounding that takes a beginning value to an ending value over n periods (typically n ≥ 2). Formula: (Ending ÷ Beginning)^(1⁄n) − 1. For adjacent years (n = 1), it equals (Ending ÷ Beginning) − 1 (i.e., simple YoY growth).",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "It lowers WACC up to a optimal leverage point, then raises it. Debt is cheaper than equity (tax shield + seniority), so replacing equity with debt pushes WACC down. Beyond a certain leverage, rising default risk drives up the cost of debt and the cost of equity, causing the familiar U‑shape.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
    ...
    "reported": "Centerview Partners interview · SA 2025, off-cycle, London office"
  },
  {
    "id": 669,
    ...
    "answer": "At first glance, the cheaper (10x) might seem more attractive. But you need to investigate reasons why one trades at a higher multiple: better management, higher margins, better growth prospects, or lower risk? If all truly is identical, the lower multiple could suggest undervaluation, but in reality, there might be intangible differences justifying the higher multiple.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "If the P/E is 10x, $10m/year in additional net income (assuming no change in taxes or anything else) translates to an extra $100m in equity value (10 x $10m). So, you’d add that to the existing $100m, resulting in $200m new equity value. In practice, you'd adjust for taxes, but that's the high-level approach.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "You might use EV/Revenue or EV/Growth (like EV/EBITDA-growth), especially if they aren’t profitable. Some also look at PEG ratios (P/E to Growth). In high-growth SaaS, EV/ARR (Annual Recurring Revenue) can be more relevant than EV/EBITDA if EBIT is minimal or negative.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Lyft. Lyft is smaller and has a higher beta, so its required return is higher than a large, diversified tech company like Meta.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Comprehensive valuation approach: Understand the business: Revenue model, cost structure, competitive position, growth drivers. Comparable Company Analysis: Identify public peers, select appropriate multiples based on business model. Precedent Transactions: Research M&A activity in the sector for acquisition multiples. DCF Analysis: Build financial projections, determine WACC, calculate terminal value, discount to present value. Triangulate: Synthesize results from multiple methodologies to arrive at a valuation range. Tailor your answer to the specific company, highlighting industry-specific considerations.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 677,
    "question": "Company A has a Net Debt of $500 and trades at an EV/EBITDA multiple of 12.5x, while its direct peers trade at an average of 13.0x.\nWhat are some potential reasons for this valuation discount?",
  ...
  {
    "id": 681,
    "question": "A pharmaceutical company and an auto manufacturer have identical financials.\nWhich has the larger equity value, and why?",
    "answer": "The pharma company likely has the higher equity value. Pharma typically trades at higher multiples due to growth potential, IP, and less cyclicality.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 683,
    "question": "Describe a lesser-known valuation methodology.\nExplain how it works and when you would use it.",
    "answer": "One lesser-known approach is the “Sum of the Parts” (SOTP) analysis for conglomerates or multi-segment companies. You value each division separately using a suitable methodology (Comps, DCF, etc.) and then add them, adjusting for net debt/corporate overhead. It’s used when segments have very different business models, growth rates, or risk profiles.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
    ...
    "reported": "FT Partners interview"
  },
  {
    "id": 684,
    "question": "How do you build a public-company comparables set?",
    "answer": "You would look at a few factors: Industry Financials (i.e. Revenue, EBITDA) Geography The industry is the most important factor. Some examples of screens: Retail apparel brands with market caps above $2 billion Enterprise SaaS companies with growth rates above 30%",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "From least to most discretionary: Maintain required cash for operations Pay down existing debt Invest in core business (capex, R&D) Make acquisitions Pay dividends or repurchase shares",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "EPS = Net Income / Shares Outstanding. Price per Share x Shares Outstanding = Market Cap (Equity Value). P/E = Price per Share / EPS = Market Cap / Net Income.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "In a simplistic view, value = Cash Flow / Discount Rate. If the discount rate is, say, 5%, the value is $100 / 0.05 = $2,000.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Answer: 40% Calculation: EV/Sales = 2.0x means EV = 2.0 × Sales. EV/EBITDA = 5.0x means EV = 5.0 × EBITDA. Therefore: 2.0 × Sales = 5.0 × EBITDA. EBITDA / Sales = 2.0 / 5.0 = 0.40 = 40%.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "A lower multiple vs. peers might suggest undervaluation, especially if fundamentals are comparable. Of course, you'd also consider synergy potential, strategic fit, and discount to precedent deals.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 693,
    "question": "A company traded at a 10x EV/EBITDA in 2023 and 12x EV/EBITDA in 2024.\nWhat does that imply about the company's cash flows?",
    "answer": "Investors now pay more for each dollar of EBITDA. The expansion signals either higher expected growth or lower perceived risk; EV rose faster than EBITDA (or EBITDA fell) even before any new cash flows materialized.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
    ...
    "reported": "Guggenheim Partners interview · M&A, superday"
  },
  {
    "id": 694,
    ...
    "answer": "WACC = Cost of Equity * (% Equity) + Cost of Debt * (% Debt) * (1 - Tax Rate). Cost of Equity via CAPM = Risk‑free rate + β × Equity risk premium. Cost of Debt from current or implied borrowing cost. Interest expense is tax‑deductible, so the after‑tax cost of debt is Cost of Debt × (1 − t), lowering the firm’s effective financing cost.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 695,
    "question": "Back-to-back questions on Beta:\nWhat does beta measure, and how is it calculated?\nWhat does a beta of −1 or 2 indicate?\nWhat does a beta of 0 signify?",
    "answer": "Beta measures an asset's systematic risk relative to the market. β = Covariance(stock, market) / Variance(market). Interpretation: β = −1 → moves opposite the market one‑for‑one. β = 2 → twice as volatile as the market in the same direction. β = 0 → no correlation with market movements.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "EV/EBITDA: Best for comparing companies with different capital structures. Normalizes for leverage. Most common in M&A and LBO analysis. P/E: Best for profitable companies with comparable capital structures. Equity-focused metric. Common in public market analysis. EV/Revenue: Best for unprofitable or early-stage companies. Useful when EBITDA is negative or not meaningful. Common in high-growth tech sectors.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "To calculate the Enterprise Value (EV): First, calculate EBITDA: $1 billion * 20% = $200 million. Next, apply the EV/EBITDA multiple: EV = 6 * $200 million = $1.2 billion. Therefore, the company's Enterprise Value is $1.2 billion.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "EBITDA is popular because it’s a proxy for operating cash flow, but it can ignore capex, working capital needs, and interest. Alternatives include EBIT, which accounts for depreciation, or EBITDA–Capex, which factors in maintenance spending. For banks, you might use P/E or P/B.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 701,
    "question": "Select two similar, publicly traded companies in an industry you follow.\nWhy does one trade at a higher valuation multiple than the other?",
    "answer": "Sample answer framework: Company A trades at higher multiples than Company B because: Higher revenue growth rate (20% vs. 10%). Superior profit margins (30% vs. 20% EBITDA margin). Stronger market position and brand recognition. Better management execution track record. More recurring revenue and customer retention. Lower capital intensity and higher ROIC. Note: Provide specific companies and metrics based on your industry knowledge.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Use objective filters first, then qualitative judgment. Industry / business model Geography Size (revenue, EBITDA, market cap) Growth and margin profile Capital structure / leverage Pull the universe from databases (CapIQ, FactSet), apply the filters, then read filings to confirm comparability.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "SOTP values each business segment separately and adds them to arrive at total enterprise value. It is useful for conglomerates with divisions that trade on different multiples or have distinct risk/growth profiles and can reveal hidden value or break‑up potential.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Because after‑tax Cost of Debt is usually below Cost of Equity, adding reasonable leverage lowers WACC up to an optimal point. Beyond that point, default risk lifts both the Cost of Debt and the equity risk premium, causing WACC to rise.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Initially WACC falls because after‑tax debt is cheaper than equity. Beyond an optimal point, rising default risk pushes up the cost of both debt and equity, so WACC rises.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Bankers use EBITDA because it provides a measure of operational performance that excludes the effects of financing and accounting decisions, allowing for easier comparison between companies. However, EBITDA has drawbacks, including ignoring capital expenditures, working capital changes, and not accounting for debt, which can lead to an incomplete view of a company's financial health.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "$2.0 B EV = 6 × 400 = 2,400. Equity = EV – Debt + Cash = 2,400 – 600 + 200 = 2,000.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Nvidia. Its rapid growth and capital‑light model command a materially higher earnings multiple than GM’s cyclical, asset‑heavy auto business.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "5 %. Interest expense = EBITDA / 4. Debt = 5 × EBITDA. Interest rate = (EBITDA / 4) ÷ (5 × EBITDA) = 1 / 20 = 5%.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 715,
    "question": "Imagine you have a standard x vs. y plot of WACC vs. Leverage.\nWhat is the shape of that plot?",
    "answer": "A U‑shaped curve. WACC falls at first as tax‑advantaged debt replaces costlier equity, bottoms out at the optimal capital structure, then climbs as financial distress risk overwhelms the tax benefit.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 716,
    "question": "A firm has Unlevered Beta = 1, Equity Risk Premium = 5%, Risk-free Rate = 5%, Tax = 50%, D/E = 1.\nFind the cost of equity.",
    "answer": "12.5% Levered Beta = 1 × [1 + (1 − 50%) × 1] = 1.5. Cost of Equity = 5% + (1.5 × 5%) = 12.5%.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Compare the present value of the sale price now vs. the expected sale price in one year discounted back, factoring in potential depreciation or usage cost, plus any opportunity cost or additional income from using the machine for that year.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "As credit ratings improve, lenders perceive lower default risk, which generally lowers the interest rate demanded. Thus, cost of debt decreases, improving the company’s overall WACC if it’s using debt financing.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 729,
    "question": "Companies A, B, and C all have the same EBITDA this year.\nTheir EV / EBITDA multiples are 8x, 9x, and 10x now, but forward multiples are 10x, 9x, and 8x respectively.\nWhich company would you invest in?",
    "answer": "Answer: Company C is the most attractive investment. Here's why: Company A is expected to have declining EBITDA, since its forward multiple rises (8x → 10x). This suggests deteriorating future earnings. Company B is expected to have stable EBITDA, since its forward multiple remains the same (9x). This suggests limited upside compared to growth-oriented peers. Company C is expected to have growing EBITDA, since its forward multiple falls (10x → 8x). This suggests strong EBITDA growth. The market pays a premium for future growth.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
    ...
    "reported": "Nomura Greentech interview"
  },
  {
    "id": 730,
    "question": "Aside from standard metrics like EV/EBITDA or EV/Revenue, what is another key metric you could use to evaluate a company's efficiency?\nHow is it calculated and what does it tell you?",
  ...
  },
  {
    ...
    "answer": "Initially lowers WACC thanks to cheaper after‑tax debt, but beyond an optimal leverage point distress risk pushes WACC back up.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
    ...
    "reported": "Piper Sandler interview · SA 2025, off-cycle, London office"
  },
  {
    "id": 732,
    "question": "A company has a $200M market cap and trades at 10x P/E.What is its net income?",
    "answer": "$20 mm (because $200 mm ÷ 10 = $20 mm).",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 733,
    "question": "You have a coverage ratio of 4 and a debt ratio of 2 and need the interest rate.\nHow do you compute it?",
    "answer": "Let EBIT = 100. Interest = EBIT ÷ Coverage = 100 ÷ 4 = 25. Debt = Ratio × EBIT = 2 × 100 = 200. Cost of debt = Interest ÷ Debt = 25 ÷ 200 = 0.125 (12.5%).",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "They raise it. Under CAPM, Cost of Equity = Risk‑free Rate + β × Equity‑Risk‑Premium. When a central bank hikes policy rates, government bond yields—your risk‑free proxy—move up. Holding β and the ERP constant, the higher risk‑free rate flows straight through to a higher cost of equity, raising discount rates and lowering valuations.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "EBITDA is $50M. If the purchase price multiple is 10x EBITDA, the purchase price refers to enterprise value in many cases. EV = 200 equity + 300 debt = 500. 500 / 10 = 50.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 740,
    "question": "A company has an EV/Sales multiple of 5x and an EBITDA margin of 20%.\nWhat is its EV/EBITDA multiple?",
    "answer": "Full-Time Analyst 2026, NYC Office Valuation Answer: 25x Calculation: EBITDA = Revenue × EBITDA Margin = Revenue × 20% = 0.2 × Revenue. EV = 5x × Revenue. EV/EBITDA = (5 × Revenue) / (0.2 × Revenue) = 5 / 0.2 = 25x.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
    ...
    "reported": "Solomon Partners interview"
  },
  {
    "id": 741,
  ...
  {
    "id": 742,
    "question": "Why is debt cheaper than equity?\nWhat is the correlation with interest rates?",
    "answer": "Debt sits higher in the capital stack and receives fixed coupons, so investors demand lower returns than residual equity holders. Interest rates set the risk‑free baseline; as central‑bank rates rise, the absolute cost of debt climbs and the after‑tax advantage versus equity narrows.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 746,
    "question": "Calculate the EV/Revenue multiple for the following two companies:\nCompany A: $100M Revenue, 30% EBITDA Margin, 8x EV/EBITDA multiple.\nCompany B: $50M Revenue, 20% EBITDA Margin, 10x EV/EBITDA multiple.",
    "answer": "Company A: EBITDA = $100M * 30% = $30M EV = $30M * 8x = $240M EV/Revenue = $240M / $100M = 2.4x Company B: EBITDA = $50M * 20% = $10M EV = $10M * 10x = $100M EV/Revenue = $100M / $50M = 2.0x",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Multiple factors beyond current financials drive P/E: Growth expectations: Higher expected growth commands higher P/E Risk profile: Lower risk (stable industry) supports higher P/E Management quality: Better leadership drives premium valuation Competitive position: Stronger moat/market share justifies higher P/E Capital structure: Different leverage levels affect equity risk and P/E Market sentiment: Sector rotation, investor preferences Liquidity: More liquid stocks trade at premium Accounting quality: One-time items, aggressive accounting can depress P/E",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 748,
    "question": "A company's WACC is 12%, and its after-tax cost of debt is 7%. Its capital structure is 50% debt and 50% equity.\nWhat is the company's cost of equity? (Note: the provided tax rate of 30% is not needed).",
    "answer": "Answer: 17% Calculation: WACC = (Weight of Debt * Cost of Debt) + (Weight of Equity * Cost of Equity) 12% = (50% * 7%) + (50% * Cost of Equity) 12% = 3.5% + (50% * Cost of Equity) 8.5% = 50% * Cost of Equity Cost of Equity = 17%",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 749,
    "question": "You are reviewing a comparable companies analysis with five companies. Four of them trade in an 8-10x EV/EBITDA range, but one trades at 20x.\nWhat are the possible reasons for this outlier, and what steps would you take to investigate?",
  ...
  {
    "id": 750,
    "question": "Two companies are the same size, in the same industry, and have the same revenue, but different EBITDAs.\nWhat are some possible reasons for this discrepancy?",
  ...
  {
    "id": 752,
    "question": "You are given three companies, each with an EBITDA of $100M, and EV/EBITDA multiples of 2.0x, 3.0x, and 4.0x, respectively.\nPart 1: Plot the Enterprise Value for the three companies on a graph.\nPart 2: Explain the shape of the graph and your rationale.",
    "answer": "Part 1: Enterprise Values Company 1: EV = $100M * 2.0x = $200M Company 2: EV = $100M * 3.0x = $300M Company 3: EV = $100M * 4.0x = $400M Part 2: Graph Shape and Rationale The graph shows a linear relationship between EV/EBITDA multiples and Enterprise Value. Each 1.0x increase in multiple adds $100M to Enterprise Value. Higher multiples reflect better growth prospects, margins, or lower risk. The linear relationship demonstrates that valuation scales proportionally with the multiple applied.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "If a firm invests capital at a return that exceeds its cost of capital, it’s creating economic value. In other words, ROIC > WACC means every dollar invested returns more than it costs, leading to value creation for shareholders.",
    "topic": "Valuation",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Use Gordon Growth: required return = yield + growth = 14%. Pay 1 / (14% − 10%) = 25× the current dividend to achieve that return.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
    ...
    "reported": "BMO interview · SA 2026, Toronto office, First round"
  },
  {
    "id": 759,
  ...
  },
  {
    ...
    "answer": "The publicly listed U.S. company often trades at a higher multiple due to greater liquidity, regulatory transparency, and perceived lower risk. The private Colombian company might be discounted for less liquidity, potential political/currency risk, and less disclosure.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 762,
    "question": "Calculate Beta given the following information:\nThe correlation coefficient between a stock and the market is 0.5.\nThe ratio of the standard deviation of the stock to the standard deviation of the market is 2.0.",
    "answer": "Answer: 1.0 Calculation: Beta = Correlation * (Std Dev Stock / Std Dev Market) Beta = 0.5 * 2.0 = 1.0 A beta of 1.0 means the stock moves in line with the market on average, despite having twice the volatility, because the correlation is only 0.5.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "reported": "Credit Suisse interview · Financial Sponsors group, New York Office, Second round"
  },
  {
    "id": 765,
  ...
  {
    "id": 767,
    "question": "Given: P/E=20x, EV/EBITDA=10x, Int Exp=$20M, Int Rate=5%, Dep=$20M, Market Cap=$200M.\nWhat is the effective tax rate?",
    "answer": "Answer: 50% Calculation: NI = Market Cap / (P/E) = $200m / 20x = $10M. Debt = Int Exp / Int Rate = $20m / 5% = $400M. EV = Market Cap + Debt = $200m + $400m = $600M (assume no cash, preferred or NCI). EBITDA = EV / (EV/EBITDA) = $600m / 10x = $60M. Pre-Tax Income (EBT) = EBITDA - D&A - Int Exp = $60m - $20m - $20m = $20M. Tax = EBT - NI = $20m - $10m = $10M. Tax Rate = Tax / EBT = $10m / $20m = 50%.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 768,
    "question": "Two airlines have the same enterprise value.\nOne uses capital leases, the other operating leases.\nWhich trades at a higher EBITDA multiple?",
    "answer": "The airline with operating leases trades at a higher EBITDA multiple because lease expense reduces EBITDA, making the multiple higher.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 769,
    "question": "P/E is 40x, EV/Revenue is 10x, net income is $15mm, $400mm in debt, no cash.\nDepreciation is $10mm, EBITDA margin is 50%, and tax rate is 25%. What is the interest rate?",
    "answer": "Equity value = 40 × 15 = $600 mm; EV = 600 + 400 = $1,000 mm. Revenue = 1,000 ÷ 10 = $100 mm; EBITDA = 50% × 100 = $50 mm. EBIT = 50 − 10 = $40 mm; EBT = 15 ÷ 0.75 = $20 mm. Interest expense = 40 − 20 = $20 mm. Interest rate = 20 ÷ 400 = 5%.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Multiples embed growth, risk and cash‑flow quality; small differences here drive valuation gaps. Key factors: Different forward growth rates. Margin and cost‑structure resilience. Capital intensity and FCF conversion. Return on invested capital. Business‑risk profile: cyclicality, regulatory, concentration. Size, liquidity and trading float. Scarcity value or strategic buyer interest.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "reported": "Evercore interview · SF office"
  },
  {
    "id": 772,
    "question": "Explain the appropriate use cases for EV/EBIT, EV/EBITDA, and EV/EBITDAR valuation multiples.\nFollow-up: What are the potential drawbacks or limitations of using EV/EBITDAR?",
    "answer": "Part 1: Use Cases EV/EBIT: When D&A is consistent across comparables or immaterial. Closer to actual profitability. EV/EBITDA: Standard for most industries. Neutralizes depreciation policy differences and capital intensity variations. EV/EBITDAR: For companies with significant operating leases (airlines, retail). Adds back rent to compare companies with different lease vs. own decisions. Part 2: EBITDAR Limitations Less commonly used, making comparables harder to find. Can overstate profitability by excluding real operating costs. Rent is typically a genuine cash expense unlike D&A. Modern accounting (ASC 842/IFRS 16) capitalizes leases, reducing need for EBITDAR.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 773,
    "question": "You are advising a publicly traded client with two businesses: broadcasting and digital media. The facts are as follows:\nBroadcasting peers trade at 7x EBITDA.\nDigital media peers trade at 14x EBITDA.\nYour client's consolidated company trades at 8x EBITDA.\nThere are no synergies between the two businesses.\nWhat strategic recommendation would you make to the client to create value? If they decide to sell a business, which one should they sell and why?",
    "answer": "Recommendation: Spin off or sell the digital media business. Rationale: The conglomerate trades at 8x, below the 14x multiple for pure-play digital media companies. Market is applying a conglomerate discount, undervaluing the digital media segment. Separating allows digital media to trade at its natural 14x multiple. Broadcasting would trade at 7x standalone. Sum-of-the-parts valuation exceeds current consolidated 8x multiple. Sell the digital media business to capture the 14x multiple arbitrage and unlock shareholder value.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
    ...
    "reported": "Evercore interview · New York Office, Second round"
  },
  {
    "id": 774,
    "question": "Part 1: Given a bond's price, par value, coupon rate, and maturity, how do you calculate its Yield to Maturity (YTM)?\nPart 2: How would the YTM be impacted if the coupon payments were changed from annual to semi-annual?",
    "answer": "Part 1: YTM Calculation YTM is the internal rate of return (IRR) that equates the present value of all future cash flows to the current bond price. Approximation Formula: YTM = [C + (F - P) / n] / [(F + P) / 2] C = Annual coupon payment F = Face value P = Current price n = Years to maturity Precise calculation requires iterative solving or financial calculator. Part 2: Semi-Annual Impact Semi-annual coupons typically result in slightly higher effective YTM due to more frequent compounding and reinvestment of coupon payments. The stated YTM with semi-annual payments must be doubled to get the annual rate (bond equivalent yield), but the effective annual rate will be marginally higher than with annual payments.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Banks are often valued using P/B (Price to Book) and P/E multiples. You also look at the Return on Equity (ROE), net interest margin, and capital ratios. A Dividend Discount Model (DDM) is also common, discounting the future dividends (or residual income) by the cost of equity. DCF is less common due to the complexity of bank balance sheets and regulatory capital requirements.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "The 5% increase in price yields the highest absolute EBITDA ($15M), making it the most attractive (assuming costs scale proportionally and customers are perfectly price inelastic). 10% Increase in Quantity (assuming costs scale proportionally): Revenue = $110M, Costs = $99M → EBITDA = $11M 5% Increase in Price (assuming no drop in volume): Revenue = $105M, Costs = $90M → EBITDA = $15M 5% Reduction in Costs: Revenue = $100M, Costs = $85.5M → EBITDA = $14.5M In practice, if we assume any meaningful price sensitivity on customers, the 5% increase in price would correspond to a drop in volume. Depending on how big that drop in volume is, the 5% reduction in cost may become more desirable.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "EV/Sales = 2x and EV/EBITDA = 5x. EBITDA Margin = EBITDA / Sales = (EV / Sales) / (EV / EBITDA) = 2 / 5 = 40%",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 779,
    "question": "Forward revenue multiple is 5x, forward EBITDA multiple is 10x.\nTwo-year forward revenue multiple is 10x, two-year forward EBITDA multiple is 25x.\nWhat does this tell you about the business? If EV is 200m, do some calculations.",
    "answer": "Next Year: Revenue₁ = 200 / 5 = 40 EBITDA₁ = 200 / 10 = 20 Two Years Out: Revenue₂ = 200 / 10 = 20 EBITDA₂ = 200 / 25 = 8 The steep jump in multiples implies earnings are expected to fall sharply—investors think the current downturn is temporary or the company is highly cyclical.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Most to least accretive: $10 CapEx decrease $10 expense decrease $10 revenue increase CapEx cuts lift FCF dollar‑for‑dollar. Expense savings boost EBIT, but only by 10 × (1–tax). Revenue gains flow through at the after‑tax margin, so impact is smallest.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "This suggests the company has a favorable capital structure: Lower debt levels reduce EV but not equity value. Less interest expense means higher net income. Lower EV/EBITDA (due to less debt) but higher P/E (due to higher NI). Company may also have significant cash holdings. Example: Low-leveraged company with strong cash generation trades at premium P/E but discount EV/EBITDA.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 782,
    "question": "A company has perpetual free cash flow of $100 million, which is expected to grow at 5% annually.\nThe appropriate discount rate is 10%.\nThe company's market capitalization is $2 billion, based on 100 million shares outstanding at a price of $20 per share.\nWhat does this information tell you about the company's valuation?",
  ...
  {
    "id": 787,
    "question": "You are comparing two companies, A and B, which are operationally identical except for their size.\nCompany A: Share price of $10, 100 shares, Net Debt of $100, EBITDA of $100.\nCompany B: Share price of $100, 100 shares, Net Debt of $1,000, EBITDA of $1,100.\nBased on this information, which company would you prefer to invest in and why?",
    "answer": "The choice between Company A and Company B involves a trade-off between value and risk. Analysis: Company A: EV = ($10 × 100) + $100 = $1,100. EV/EBITDA = $1,100 / $100 = 11.0x. Debt/EBITDA = $100 / $100 = 1.0x. Company B: EV = ($100 × 100) + $1,000 = $11,000. EV/EBITDA = $11,000 / $1,100 = 10.0x. Debt/EBITDA = $1,000 / $1,100 = 0.91x. Conclusion: Company B is the superior investment based on these metrics. It trades at a lower valuation multiple (10.0x vs. 11.0x), suggesting it is cheaper, and it also has lower leverage (0.91x vs. 1.0x), indicating it is less risky. Therefore, an investor would prefer Company B as it offers better value with a stronger credit profile.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Answer: $127.50 Calculation: Current Share Price = EPS * P/E = $7 * 15x = $105. Current NI after-tax = $7 per share. Pre-tax income = $7 / (1 - 30%) = $10 per share. New NI = $10 * (1 - 15%) = $8.50 per share (assumes P/E remains constant). New Share Price = $8.50 * 15x = $127.50.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "DCF drivers: Free Cash Flow growth. Discount rate (WACC). Terminal value assumptions. LBO drivers: Entry valuation. Leverage and cost of debt. Cash‑flow growth and margin expansion. Exit multiple and timing.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 796,
    "question": "Company H has $150 M unlevered FCF, a 2% risk-free rate, a 4%market risk premium, and a beta of 2.\nWhat is the EV if the company is all equity?",
    "answer": "Answer: $1.5 B Cost of equity = 2% + (2 × 4%)= 10%. With zero-growth perpetuity formula, EV = 150 / 0.10 = 1,500 M ≈ 1.5B.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Unlevered beta isolates business risk; levered beta adds financial risk from debt. We un‑lever peers to strip out capital‑structure effects, average them, then re‑lever at target debt‑to‑equity to derive a beta consistent with the firm’s planned leverage in a CAPM cost‑of‑equity.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Company A’s return must come primarily from EBITDA growth and debt pay‑down because the multiple is contracting. Company B benefits from multiple expansion, so valuation re‑rating—not operating growth—will drive a larger share of returns.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Build a finite‑life DCF model that forecasts yearly cash flows until shutdown and adds a salvage value, with no perpetuity. A perpetual multiple or Gordon Growth approach would overstate value because production stops after year 10.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 800,
    "question": "Equity risk premium is 5%, risk-free rate is 5%, unlevered beta is 1, D/E ratio is 1x, and tax rate is 50%.\nCalculate the cost of equity.",
    "answer": "Levered β = 1 × [1 + (1 − 50%) × 1] = 1.5. Cost of Equity = 5% + 1.5 × 5% = 12.5%.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 801,
    "question": "A company has $120 in EBITDA at a 10x multiple and a 20% EBITDA margin.\nDebt/EBITDA is 5x, interest rate is 10%, P/E is 20x.\nWhat is the tax rate?",
    "answer": "50%. EV = 1,200; Debt = 600 ⇒ Equity = 600. NI = 600/20 = 30. EBIT ≈ 120 (assume no D&A). Interest = 60. EBT = 60 ⇒ Taxes = 30 ⇒ 30/60 = 50%.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "≈ 33%. EV = 800; Debt = 500 ⇒ Equity = 300. NI = 300/10 = 30. EBIT = 95. Interest = 50. EBT = 45 ⇒ Taxes = 15 ⇒ 15/45 ≈ 33%.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 803,
    "question": "Calculate EV given:\nLFCF yield = 10%, EBITDA = 150, D&A = 50, interest expense = 10, capex = 30,Increase in A/R = 20, Decrease in A/P = 10, Increase in Inventory = 5, taxes = 25, debt = 300, cash = 75.",
    "answer": "EV ≈ 725. EBIT = 100. NI = 65. LFCF = 50 (CFO [65 NI + 50 D&A - 35 NWC] - 30 Capex). Equity Value = 50/0.10 = 500. EV = 500 + 300 − 75 = 725.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 804,
    "question": "Two companies appear very similar, yet one trades at a higher EV/EBITDA multiple.\nWhy might this be the case?\nWhat other metrics could you look at?\nWould a company investing more in Capex have a higher or lower multiple?",
    "answer": "Possible drivers of multiple divergence: Growth, margin, or cyclicality differences Leverage or liquidity risk IP quality or regulatory moats Geographic or customer concentration Other metrics: EV/Sales, EV/EBIT, P/E, FCF yield, ROIC, leverage ratios. Heavy ongoing Capex depresses FCF, usually leading to a lower EV/EBITDA multiple.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "≈ 4%. Interest = EBITDA/5. Debt = 5 × EBITDA. Interest rate = (EBITDA/5)/(5 × EBITDA) = 1/25 ≈ 4%.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "reported": "Moelis & Co. interview · Houston office, Superday"
  },
  {
    "id": 809,
  ...
  },
  {
    ...
    "answer": "For a forestry company, Terminal Value should reflect the long-term, sustainable harvest and regrowth cycles. Approaches: Perpetuity Growth Method: Use a low, stable growth rate (0-2%) reflecting sustainable timber yields and inflation. Exit Multiple: Apply EV/EBITDA multiple from comparable forestry companies at maturity. Asset-Based Approach: Value standing timber inventory and land at terminal year using per-acre or per-ton metrics. Forestry is capital-intensive with long growth cycles, so Terminal Value often represents significant portion of DCF. Use conservative assumptions given commodity price volatility and biological constraints.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 811,
    "question": "How would you value Tesla, and how would you select an appropriate set of comparable companies?\nFollow-up: In your opinion, what is the best method to value Tesla?",
  ...
  },
  {
    ...
    "answer": "Possibly for strategic value, rapid user growth, or a unique product that can become profitable at scale. You might use revenue multiples, user metrics, or a long-term DCF projection that models eventual profitability. The high multiple reflects growth expectations and potential network effects.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 813,
    "question": "Walk me through a DCF, then walk me through an LBO.\nFollow-up 1: If we change the discount rate, what happens to both?\nFollow-up 2: If we increase taxes, what happens to both?\nFollow-up 3: If we do a dividend recap, how does that affect the LBO?\nFollow-up 4: Compare high yield debt vs. bank debt in an LBO.",
  ...
  },
  {
    ...
    "answer": "EBITDA: Ignores capex (no reflection of ongoing maintenance or growth investments). EBIT: Includes depreciation (a non-cash item) but might still not reflect actual cash outflows for capex. EBITDA – Capex: Helps account for ongoing reinvestment needs, offering a closer proxy to true cash flow.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Between them. Preferred dividends are contractually senior to common equity but junior to debt, so investors demand a return higher than debt yet lower than equity.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Both value equity but use different mechanics and solve for different things. Levered DCF projects Levered Free Cash Flow and discounts it at the Cost of Equity to tell you what the equity is worth today. An LBO projects the same cash flows but solves for the IRR a sponsor earns given a purchase price, leverage and exit multiple; it doesn’t discount cash flows.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 827,
    "question": "Company A is financed with debt, while identical Company B has no debt.\nAnswer the following:\nHow would you expect their P/E multiples to differ?\nIf both companies' revenues increase by 30%, how might their respective multiples react?\nWhich company has a higher cost of capital?",
    "answer": "Part 1: P/E Multiples Company B (unlevered) has a higher P/E multiple. Leverage adds risk, causing investors to demand a higher return on equity. A higher required return results in a lower P/E multiple. Part 2: Multiple Reaction to Growth Company A's P/E could compress or expand. Mechanically, NI grows faster for levered companies (fixed interest), which could lower the P/E ratio. However, strong growth also leads to de-leveraging and de-risking, which could cause the market to award a higher multiple. Part 3: Cost of Capital Company B (unlevered) has a higher cost of capital. Its capital structure is 100% equity, which is more expensive than debt. Company A benefits from cheaper, tax-advantaged debt in its WACC.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Essential questions to ask: What is your current annual revenue and EBITDA margin? What is your revenue growth rate over the past 2-3 years? What is your net debt position (or cash balance)? Who are your closest public comparables? What are your key value drivers and competitive advantages? What is your capital intensity (annual capex as % of revenue)? With these answers, you can quickly apply a trading comp multiple to EBITDA and triangulate an approximate Enterprise Value and Equity Value.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 829,
    "question": "A company has an EPS of $7 and a P/E multiple of 15x. The corporate tax rate then drops from 30% to 15%.\nAssuming the P/E multiple remains constant, what is the new share price?",
    "answer": "Answer: $127.50 Calculation: Current Share Price = EPS * P/E = $7 * 15x = $105. Current Pre-Tax Income = $7 / (1 - 30%) = $10. New Net Income = $10 * (1 - 15%) = $8.50. New Share Price = $8.50 * 15x = $127.50. Note: The lower tax rate increases NI and EPS, which flows through to a higher share price even with the same multiple.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 830,
    "question": "A bond has the following characteristics:\nFace Value: $1,000\nAnnual Coupon Rate: 10%\nPurchase Price: $500\nYears to Maturity: 3\nWhat is the bond's Yield to Maturity (YTM)? Use the approximation formula.",
    "answer": "Answer: ~35.6% Calculation (using approximation formula): Annual Coupon = $1,000 * 10% = $100. YTM = [C + ((F - P) / n)] / [(F + P) / 2] YTM = [$100 + (($1,000 - $500) / 3)] / [($1,000 + $500) / 2] YTM = [$100 + $166.67] / $750 YTM = $266.67 / $750 = ~35.6% The approximate Yield to Maturity using the standard approximation formula is 35.6%.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "EV/EBITDA: No direct impact, as EBITDA excludes D&A (which results from past CapEx). EV/EBIT: Higher CapEx leads to higher D&A, which lowers EBIT, increasing the EV/EBIT multiple. P/E: Higher CapEx leads to higher D&A, which lowers pre-tax income and NI, increasing the P/E multiple (assuming EV/equity value held constant). Note: While CapEx itself doesn't appear in these metrics directly, it drives depreciation which impacts EBIT and NI.",
    "topic": "Valuation",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
