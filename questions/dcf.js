...
const DCF = [
  ...
  },
  {
    ...
    "answer": "Answer: 21x Calculation: Terminal Value = FCF * (1 + g) / (WACC - g) TV / FCF = (1 + g) / (WACC - g) TV / FCF = (1.05) / (0.10 - 0.05) = 1.05 / 0.05 = 21x The implied exit multiple is 21x the terminal year's FCF (not next year's).",
    "topic": "DCF",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "You analyze historical performance, discuss management guidance, examine industry benchmarks for growth, margins, capex, and working capital. Then form best estimates for revenue growth rates, operating margins, tax rates, capex, and WACC or discount rate.",
    "topic": "DCF",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "A lower beta (less volatile stock relative to the market), lower risk-free rate environment, or a lower equity risk premium can bring down cost of equity. Also, stable, diversified business models or strong brand moats lead to lower perceived risk, reducing the required return by investors.",
    "topic": "DCF",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Answer: $7,300 Calculation: Annual cash flow = $1/day × 365 days = $365 Perpetuity Value = Annual Cash Flow / Discount Rate PV = $365 / 0.05 = $7,300",
    "topic": "DCF",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 842,
    "question": "Answer the following questions about a DCF analysis:\nWhat are the two most important drivers of value in a DCF?\nHow do you calculate the Weighted Average Cost of Capital (WACC), Cost of Equity, and Beta?\nHow do you determine the Beta for a private company?",
    "answer": "Part 1: Key Drivers The two most important value drivers are: Cash flow growth (revenue growth, margins, working capital). Discount rate (WACC) and terminal value assumptions. Part 2: Formulas WACC = (E/V × Cost of Equity) + (D/V × Cost of Debt × (1 - Tax Rate)). Cost of Equity = Risk-Free Rate + Beta × Equity Risk Premium. Beta = Covariance(Stock, Market) / Variance(Market). Part 3: Private Company Beta Use comparable public companies: Find betas of similar public companies. Unlever each beta: Unlevered Beta = Levered Beta / [1 + (1 - Tax Rate) × (D/E)]. Average the unlevered betas. Relever using the private company's target capital structure.",
    "topic": "DCF",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Revenue - COGS - OpEx = EBIT (operating income) EBIT * (1 - tax rate) = NOPAT NOPAT + D&A and other non-cash charges - CapEx - Change in Working Capital = Unlevered Free Cash Flow",
    "topic": "DCF",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Shifts each cash‑flow discount date back half a period, raising present value and enterprise value. The uplift reflects the fact that cash is earned throughout the year, not just at year‑end.",
    "topic": "DCF",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Free Cash Flow is the discretionary cash a company generates after funding operations and maintenance capex. Unlevered FCF = EBIT × (1 − tax rate) + D&A − Capex − ΔNWC It matters because it is the cash available to all capital providers and drives intrinsic value in a DCF.",
    "topic": "DCF",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Higher taxes reduce after-tax EBIT (NOPAT), and thus reduce unlevered free cash flow. The lower cash flows lead to a lower DCF valuation, all else being equal. You might also adjust WACC if the capital structure is affected, but typically the direct effect is on lower free cash flow.",
    "topic": "DCF",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 851,
    "question": "Why is the yield on the 10-year U.S. Treasury note often used as the risk-free rate?\nIn practice, how do you determine a company's actual cost of debt?",
    "answer": "Risk‑Free Rate Backed by the U.S. government > negligible default risk. 10‑year matches long‑term corporate cash‑flow horizon. Highly liquid benchmark traded daily. Cost of Debt Use the yield‐to‑maturity on existing traded bonds. If private, add credit‑spread from rating comps to risk‑free rate. Adjust for tax shield: after‑tax cost = pretax × (1 − tax rate).",
    "topic": "DCF",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 852,
    "question": "$10 in revenue, Opex, and Capex: Which has the biggest impact on a DCF?\n(Rank order in terms of magnitude of effect)",
    "answer": "Greatest negative to least: $10 increase in CapEx (full $10 cash outflow). $10 increase in Operating Expenses (hits EBIT but is partly offset by lower taxes). $10 increase in Revenue actually raises value; a decrease would mirror OpEx. CapEx directly reduces Free Cash Flow dollar‑for‑dollar, so its impact is largest.",
    "topic": "DCF",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "$10 lower Capex. Capex reduction raises free cash flow dollar‑for‑dollar (no tax). Operating‑expense savings add $10 × (1 – tax), and extra revenue lifts FCF by margin × (1 – tax); both smaller than the Capex impact.",
    "topic": "DCF",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Walk through: EBITDA - D&A and other non-cash charges = EBIT EBIT * (1 - tax rate) = NOPAT NOPAT + D&A and other non-cash charges - Capex - Changes in WC = UFCF",
    "topic": "DCF",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "A company would have a higher WACC due to: Higher Business Risk: More volatile cash flows, cyclical industry, or uncertain outlook increases Cost of Equity. Higher Financial Risk: More leverage increases Cost of Debt and Cost of Equity (higher beta). Lower Credit Rating: Riskier companies pay higher interest rates on debt. Less Debt in Capital Structure: Less tax shield from interest, raising blended WACC. Smaller Size: Smaller companies often have higher cost of capital due to liquidity and risk premiums. Industry: Some industries (e.g., tech startups) have inherently higher WACC than stable utilities.",
    "topic": "DCF",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 861,
    "question": "Theoretically, how is a company's ability to generate cash linked to its value?\nIf you were given a company's cash flow for each of the next 30 years, how would you derive its value?",
    "answer": "A company's value equals the present value of all future cash flows it can generate for investors. To derive value from 30 years of projected cash flows, discount each year's cash flow to present value using an appropriate discount rate (typically WACC), then sum all discounted values. Formula: Value = Σ (CFₜ / (1 + r)ᵗ) for t = 1 to 30. This is the foundation of DCF valuation. In practice, you'd also add a terminal value beyond year 30 to capture perpetual cash flows.",
    "topic": "DCF",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "reported": "Morgan Stanley interview · London office"
  },
  {
    "id": 863,
    "question": "How does an increase in leverage affect unlevered free cash flow?",
    "answer": "No direct impact. Unlevered FCF excludes interest and debt principal, so changing the capital structure leaves the metric unchanged.",
    "topic": "DCF",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "It lowers the valuation. An A/R build is a use of cash, raising ΔNWC and reducing Free Cash Flow in every forecast period. Lower FCF, when discounted, translates into a smaller present value and lower enterprise (and equity) value.",
    "topic": "DCF",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 865,
    "question": "An asset is expected to generate $100 in cash flow each year into perpetuity.\nIf the appropriate discount rate is 10%, what is this asset worth today?",
    "answer": "Answer: $1,000 Calculation: Perpetuity Value = Annual Cash Flow / Discount Rate Perpetuity Value = $100 / 10% = $1,000",
    "topic": "DCF",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Yes, DCF can value synergies. Approach: Build standalone DCF for target without synergies. Separately forecast incremental cash flows from synergies (revenue growth, cost savings, reduced CapEx, working capital benefits). Apply appropriate timing (e.g., phase in over 2-3 years). Discount synergy cash flows at appropriate rate (potentially higher rate for execution risk). Present value of synergy cash flows represents synergy value. The sum of standalone value plus synergy value equals the combined company value. The difference between this and the acquisition price determines value creation.",
    "topic": "DCF",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "The mid-year convention assumes cash flows occur in the middle of each year rather than at year-end. This results in a higher valuation because cash flows are discounted for 0.5 fewer years, increasing their present value. The mid-year convention is generally more accurate as companies generate cash throughout the year, not just on December 31st. Formula adjustment: Discount factor becomes 1/(1+r)^(n-0.5) instead of 1/(1+r)^n.",
    "topic": "DCF",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Key sensitivity drivers in a DCF: Revenue growth rate (most impactful top-line driver). EBITDA margin or operating margin (profitability). WACC (discount rate reflecting risk). Terminal growth rate (perpetuity value assumption). Terminal multiple (alternative exit assumption). CapEx as % of revenue (reinvestment needs). Working capital changes (cash conversion). Tax rate (affects after-tax cash flows). Typically create 2-way sensitivity tables for WACC vs. terminal growth rate or terminal multiple.",
    "topic": "DCF",
    "difficulty": "Basic",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 870,
    "question": "Walk me through a DCF.\nFollow-up 1: Why use a 5-10 year projection?\nFollow-up 2: Could we do a 25-year DCF?",
    "answer": "DCF steps: Project unlevered FCF for 5–10 years. Estimate terminal value (Gordon Growth or exit multiple). Discount both at WACC and sum to get enterprise value. Follow‑ups: Forecast accuracy drops sharply beyond 5–10 years; using that range balances visibility and value capture. A 25‑year DCF is theoretically possible but small forecasting errors compound, so most value practitioners rely on a shorter explicit period plus a terminal value.",
    "topic": "DCF",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 871,
    "question": "What is a levered DCF?\nFollow-up 1: What discount rate do you use?\nFollow-up 2: How do you calculate cost of equity?",
    "answer": "A levered DCF discounts cash flows after interest and mandatory principal at the Cost of Equity to value equity directly. Follow‑ups: The discount rate is the company’s Cost of Equity. Cost of Equity = Risk‑free rate + Beta × Equity risk premium ± size/sector adjustments (CAPM).",
    "topic": "DCF",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "To account for cross-border risk, you might add a country risk premium to the cost of equity. This premium reflects political, economic, and currency risks in the target country. You also might adjust the discount rate to reflect higher uncertainty or incorporate scenario analyses to account for potential currency swings, regulatory changes, or macroeconomic volatility.",
    "topic": "DCF",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 874,
    "question": "You’re valuing a high-growth SaaS firm (30% growth, 30% margin) in a DCF.\nHow do you build projections, choose an EBITDA exit multiple for terminal value, and should you base the multiple on the final projected year or the following year?",
    "answer": "Key steps & guidance: Build projections: Model revenue ramp from 30% toward a long-term stable rate (e.g. 3–5%), gradually expand margins from 30% to mature levels (40–45%) as fixed costs leverage out. Choose exit multiple: Use public & M&A comps in a stable-growth SaaS group (e.g. 12–15× EBITDA), adjusted for size, growth differential, and margin profile. Which year: If applying an LTM (Last Twelve Months) exit multiple, anchor it on the final year of your projection period (Year N). If applying an NTM (Next Twelve Months) forward multiple, apply it to the year after your projection period (Year N+1). Either way, it yields the Terminal Value at Year N.",
    "topic": "DCF",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 875,
    "question": "A company switches accounting from LIFO to FIFO.\nHow does that affect a DCF valuation?",
  ...
  },
  {
    ...
    "answer": "That suggests the company’s value is heavily in the terminal period, typical of high-growth or long-duration cash flows. It also indicates forecasting uncertainty in earlier years and that small changes in the terminal assumptions (multiple or growth rate) can dramatically affect the valuation.",
    "topic": "DCF",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 880,
    "question": "Answer the following questions:\nWhat is Net Working Capital (NWC) given: Accounts Receivable = $100, Inventory = $20, and Accounts Payable = $20?\nWalk me from Revenue to Unlevered Free Cash Flow (UFCF).\nCalculate UFCF given: Revenue = $2,000, Gross Margin = 50%, SG&A = $500, Tax Rate = 25%, Capex = $100, D&A = $50, and NWC in the current year = $40. Assume the NWC from the previous part was for the prior year.",
    "answer": "Part 1: Net Working Capital Answer: $100 NWC = AR + Inventory - AP NWC = $100 + $20 - $20 = $100 Part 2: Revenue to UFCF Revenue - COGS = Gross Profit Gross Profit - SG&A - D&A = EBIT EBIT * (1 - Tax Rate) = NOPAT NOPAT + D&A - Capex - Increase in NWC = UFCF Part 3: Calculate UFCF Answer: $347.50 Revenue = $2,000 Gross Profit = $2,000 * 50% = $1,000 EBIT = $1,000 - $500 - $50 = $450 NOPAT = $450 * (1 - 25%) = $337.50 Change in NWC = $40 - $100 = -$60 (decrease) UFCF = $337.50 + $50 - $100 - (-$60) = $347.50 Note: The decrease in NWC is a source of cash, so we add it back in the UFCF calculation.",
    "topic": "DCF",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 883,
    "question": "As an investor who uses a DCF, would you rather have a $10 increase in revenue, a $10 increase in gross profit, or a $10 decrease in CapEx?\nRank them from greatest to least impact.",
    "answer": "The most impactful would be a decrease in CapEx (no tax impact), followed by an increase in gross profit, and then an increase in revenue (since revenue growth also drives up COGS).",
    "topic": "DCF",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Even if the company is all equity now, you might assume it will add debt as it matures. You can model a target capital structure for year 10 and gradually move the WACC toward that. Alternatively, you keep a pure equity discount rate but mention that if the company leverages, the cost of debt would be factored in once it’s introduced.",
    "topic": "DCF",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Valuation would increase. Analysis: Correcting D&A upward increases the D&A add-back in FCF. EBIT decreases, but the tax shield increases (lower taxes). Net effect: Higher FCF due to the non-cash add-back exceeding the tax impact. Higher FCF leads to higher present value and thus higher valuation.",
    "topic": "DCF",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "It discounts the cash flows left after debt service to equity holders at the Cost of Equity, giving equity value directly and therefore embedding the capital structure in the valuation.",
    "topic": "DCF",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 894,
    "question": "Revenues = 1000, COGS + SG&A = 400, D&A = 200, Capex = 100, tax rate = 10%.\nLast year NWC was 150; this year it's 175. Calculate FCF.",
    "answer": "Answer: $435 EBIT = 1000 − 400 − 200 = 400 NOPAT = 400 × 0.9 = 360 Add back D&A: +200 Less Capex: −100 Less ΔNWC: 175 − 150 = 25 FCF = 360 + 200 − 100 − 25 = 435",
    "topic": "DCF",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "reported": "Lazard interview · New York Office, Second round"
  },
  {
    "id": 897,
    "question": "What is the difference between DCF and LBO cash flows, from revenue down?\n(UFCF vs. LFCF)",
    "answer": "From Revenue Down: DCF: EBIT × (1 − Tax) + D&A and other non-cash items − CapEx − ΔNWC → Unlevered Free Cash Flow. LBO: Net Income + D&A and other non-cash items − CapEx − ΔNWC − Debt service → Levered Free Cash Flow to equity. UFCF vs LFCF UFCF ignores the capital structure; it’s cash available to all providers of capital and is discounted at WACC. LFCF reflects interest expense & principal pay-down; it’s cash only to equity holders and feeds an IRR calculation in the LBO context.",
    "topic": "DCF",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 898,
    "question": "Revenue is 1000, EBITDA margin 20%, tax rate 20%, depreciation 50, capex 60, inventory up 10, accounts payable up 50.\nCalculate unlevered free cash flow (UFCF).",
    "answer": "EBITDA = 200. EBIT = 200 − 50 = 150. NOPAT = 150 × (1 − 20%) = 120. ΔNWC = 10 − 50 = −40 (source of cash). UFCF = 120 + 50 − 60 + 40 = 150.",
    "topic": "DCF",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Apply CAPM using an un‑levered average of publicly traded gold‑miner betas, then re‑lever for the target capital structure. The beta is often low or even slightly negative because gold prices can move counter‑cyclically to equities.",
    "topic": "DCF",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Full-Time Analyst 2024, SF Office, Superday DCF They should converge: maintenance CAPEX ≈ D&A, both growing at or below inflation, reflecting a steady‑state business with no incremental growth spend.",
    "topic": "DCF",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "Accelerated depreciation results in higher DCF valuation. Accelerated depreciation front-loads tax deductions, creating larger tax shields in earlier years. This increases near-term free cash flows, which are more valuable in a DCF due to time value of money (earlier cash flows are discounted less). While total depreciation over the asset's life is identical under both methods, the present value of tax savings is higher with accelerated depreciation.",
    "topic": "DCF",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 907,
    "question": "You are comparing two companies with the same EBITDA: a management consulting firm (asset-light) and a heavy manufacturing firm (capital-intensive).\nWhich company's DCF would likely yield a higher valuation, and why?",
    "answer": "The consulting firm would likely have a higher DCF valuation. Key reasons: Lower CapEx requirements mean higher Free Cash Flow despite same EBITDA. Less working capital investment needed for growth. Higher cash conversion ratio. Lower reinvestment needs to maintain operations. The manufacturing firm requires significant ongoing CapEx for equipment maintenance and replacement, reducing FCF available to equity holders.",
    "topic": "DCF",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 908,
    "question": "3 places taxes affect the DCF?\nFollow-up: How does each place get affected if taxes increase?",
    "answer": "NOPAT in FCF — higher taxes cut NOPAT and FCF. Cost of Debt — higher taxes increase the shield, lowering the after‑tax cost and WACC. Levered Beta — conversion from Unlevered to Levered. Overall, FCF falls and the discount rate may fall; valuation typically declines.",
    "topic": "DCF",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  {
    "id": 912,
    "question": "In the final year of a DCF projection, a company has the following metrics:\nEBITDA: $125D&A: $25\nTaxes: $25\nCapital Expenditures: $25\nChange in Working Capital: $0\nAssuming a perpetual cash flow growth rate of 3% and a required rate of return of 13%, what is the company's Terminal Value?",
    "answer": "Answer: $773 Calculation: EBIT = EBITDA - D&A = $125 - $25 = $100. NOPAT = EBIT - Taxes = $100 - $25 = $75. Unlevered FCF = NOPAT + D&A - CapEx - Change in NWC. Unlevered FCF = $75 + $25 - $25 - $0 = $75. Terminal Value = FCF * (1 + g) / (WACC - g). Terminal Value = $75 * (1.03) / (0.13 - 0.03) = $77.25 / 0.10 = $772.50.",
    "topic": "DCF",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
  ...
  },
  {
    ...
    "answer": "You’d still project revenue growth, operating margins, and capex assumptions for years 2–5, even if they’re estimates. For year 1, use the actuals. Then apply logical assumptions or benchmarks for subsequent years (e.g., industry growth rates, historical trends, management guidance) to forecast free cash flows and discount them back.",
    "topic": "DCF",
    "difficulty": "Advanced",
    "type": "technical",
    "firms": [
